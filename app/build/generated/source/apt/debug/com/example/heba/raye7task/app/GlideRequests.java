package com.example.heba.raye7task.app;
...
public class GlideRequests extends RequestManager {
  ...
  protected void setRequestOptions(@NonNull RequestOptions toSet) {
    if (toSet instanceof com.example.heba.raye7task.app.GlideOptions) {
      super.setRequestOptions(toSet);
    } else {
      super.setRequestOptions(new com.example.heba.raye7task.app.GlideOptions().apply(toSet));
    }
  }
}
